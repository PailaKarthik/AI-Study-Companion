...
Deterministic next-action engine. The core decision — *what* to recommend
...
unassessed concepts produce *no* candidate — silence beats busywork.
...
Staleness is judged against the rebuilt set *before* dedup, so valid
